package com.projeto.danilosetubal.mediaapp;
...
public class PrincipalActivity extends AppCompatActivity {
    ...
    public void calcular(View V) {
        ...
        try {
            ...
            if(nota1 < 0 || nota1 > 10) {
                Toast.makeText(this, "Por favor, digita a Nota 1.", Toast.LENGTH_SHORT).show();
        ...
        try {
            ...
            if(nota2 < 0 || nota2 > 10) {
                Toast.makeText(this, "Por favor, digita a Nota 2.", Toast.LENGTH_SHORT).show();
        ...
        // Chamada do método resultado dinâmico.
        resultadoDinamico();
    ...
    public void limparDados(View V) {
        ...
        // Limpar os resultados dinâmicos.
    ...
    public void resultadoDinamico() {
        ...
        // Adicionar os textViews criados no layoutResultado
